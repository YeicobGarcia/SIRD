...
urlpatterns = [
    ...
    path('RegistroSecador6/', RegistroSecador6.as_view(), name='RegistroSecador6'),    path('EstadisticaL6', EstadisticaL6.as_view(), name='EstadisticaL6'),
    path('EL6/', DashBoardL6.EstadisticaL6, name='EL6'),

    path('DashBoardL7', DashBoardL7.as_view(), name='DashBoardL7'),
    path('RegistroSecador7/', RegistroSecador7.as_view(), name='RegistroSecador7'),    path('EstadisticaL7', EstadisticaL7.as_view(), name='EstadisticaL7'),
