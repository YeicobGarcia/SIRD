    ...
    s(
      ...
      function (t) {
        ...
        function l(t, i) {
          ...
          return (
            ...
            a(i, !0) && (s.redraw(), s.graphic.attr({ opacity: 1 })),
            s
          );
        }
        function h() {
        ...
        function p(t) {
          ...
          s &&
            (n(s, "remove"),
            e(this.options.annotations, s.options),
            e(i, s),
            s.destroy());
        }
        function d() {
          ...
          ((i || (i = {})).compose = function (t, i, e) {
            ...
            if (!o.addAnnotation) {
              ...
              s(i, "afterInit", d),
                (o.addAnnotation = l),
                o.callbacks.push(h),
                (o.collectionsWithInit.annotations = [l]),
                o.collectionsWithUpdate.push("annotations"),
                (o.drawAnnotations = c),
                (o.removeAnnotation = p),
                (o.initAnnotation = function (i) {
          ...
          return class {
            ...
            mouseMoveToTranslation(t) {
              let i = t.chartX - t.prevChartX,
                ...
                e;
              return (
                this.chart.inverted && ((e = s), (s = i), (i = e)),
                { x: i, y: s }
              );
            }
            onDrag(t) {
            ...
            onMouseDown(t) {
              ...
              (i.cancelClick = !1),
                ...
                (i.removeDrag = o(
                  ...
                  function (t) {
                    (i.hasDragged = !0),
                      ((t = a?.normalize(t) || t).prevChartX = h),
                      (t.prevChartY = c),
                      n(i, "drag", t),
                      (h = t.chartX),
                      (c = t.chartY);
                ...
                (i.removeMouseUp = o(
                  ...
                  function () {
                    ...
                    t && (t.cancelClick = i.hasDragged),
                      ...
                      i.hasDragged && n(r(t, i), "afterUpdate"),
                      (i.hasDragged = !1),
                      i.onMouseUp();
                  },
                  e || l ? { passive: !1 } : void 0
          ...
          class e {
            ...
            attrsFromOptions(t) {
              ...
              for (i in t)
                (s = e[i]),
                  void 0 === e[i] ||
                    (n &&
                      -1 !== ["fill", "stroke", "stroke-width"].indexOf(s)) ||
                    (o[s] = t[i]);
              return o;
            }
            destroy() {
            ...
            update(t) {
              let i = this.annotation,
                ...
                n = this.constructor;
              this.destroy(),
                s(!0, this, new n(i, e, this.index, this.itemType)),
                this.render(o),
                this.redraw();
            }
          }
      ...
      s(
        ...
        function (t, i, s, e) {
          let { defaultMarkers: o } = i,
            { addEvent: n, defined: a, extend: r, merge: l, uniqueKey: h } = e,
            c = u("marker-end"),
            p = u("marker-start"),
            d = "rgba(192,192,192," + (s.svg ? 1e-4 : 0.002) + ")";
          function u(t) {
            return function (i) {
              this.attr(t, "url(#" + i + ")");
            };
          ...
          class f extends t {
            ...
            render(t) {
              ...
              (this.graphic = this.annotation.chart.renderer
                ...
                super.render(),
                r(this.graphic, { markerStartSetter: p, markerEndSetter: c }),
            ...
            setMarkers(t) {
              ...
              ["markerStart", "markerEnd"].forEach(function (o) {
                ...
                if (d) {
                  for (c in e)
                    if (
                      (d === ((a = e[c]).attributes && a.attributes.id) ||
                        d === a.id) &&
                      "marker" === a.tagName
                    ) {
                      r = a;
      ...
      s(
        ...
        function (t, i, s) {
          ...
          return (
            (o.attrsMap = e(i.attrsMap, { width: "width", height: "height" })),
            o
          );
        }
      ),
        ...
        function (t, i, s) {
          ...
          class n extends t {
            ...
            getAttrs(t, i) {
              ...
              return (
                a < s && (l += 180),
                { cx: a, cy: (e + n) / 2, rx: r, ry: this.getRY(), angle: l }
              );
            }
            getRY() {
              let t = this.getYAxis();
        ...
        function (t, i, s, e) {
          ...
          class h extends t {
                ...
                this.annotation.chart.styledMode ||
                  ("contrast" === e.color &&
                    (e.color = this.annotation.chart.renderer.getContrast(
                      h.shapesWithoutBackground.indexOf(i.shape) > -1
                        ? "#FFFFFF"
                        : i.backgroundColor
                    )),
            ...
            redraw(t) {
              ...
              e.attr({
                text: s
                  ? o(String(s), n.getLabelConfig(), this.annotation.chart)
                  : i.formatter.call(n, this),
              });
              let a = this.anchor(n),
                r = this.position(a);
              r
            ...
            position(t) {
              let i = this.graphic,
                ...
                g,
                m,
                f = a.series.visible && s.prototype.isInsidePlot.call(a);
              if (i && f) {
                let { width: t = 0, height: s = 0 } = i;
                l.distance && o
                  ? (d = o.getPosition.call(
                      {
                        chart: e,
                  ...
                  : l.positioner
                  ? (d = l.positioner.call(this))
                  : ((u = { x: c.x, y: c.y, width: 0, height: 0 }),
                    (d = h.alignedPosition(n(l, { width: t, height: s }), u)),
                    "justify" === this.options.overflow &&
                      (d = h.alignedPosition(
                        h.justifiedOptions(e, i, l, d),
                        u
                      ))),
                  l.crop &&
                    ((g = d.x - e.plotLeft),
                    (m = d.y - e.plotTop),
                    (f = e.isInsidePlot(g, m) && e.isInsidePlot(g + t, m + s)));
              }
              return f ? d : null;
            }
          }
        ...
        function (t, i) {
          ...
          return class {
            ...
            addCloseButton(t = "highcharts-popup-close") {
              let i = this,
                o = this.iconsURL,
                n = e("button", { className: t }, void 0, this.container);
              return (
        ...
        function (t, i) {
          ...
          return {
            ...
            addToolbar: function (t, i, e) {
              ...
              c.setAttribute("aria-label", "Annotation type"),
                c.appendChild(
                  s.createTextNode(
                    l(
                      n[i.langKey] || i.langKey,
              ...
              (p.className += " highcharts-annotation-edit-button"),
      ...
      s(
        ...
        function (t, i, s, e) {
          ...
          ((n = o || (o = {}))[(n["params.algorithm"] = 0)] =
            "params.algorithm"),
            (n[(n["params.average"] = 1)] = "params.average");
          let m = {
          ...
          function x(i, s, e, o) {
            ...
            (o.innerHTML = t.emptyHTML),
              h(
                ...
                void 0,
                o
              ).appendChild(a.createTextNode(k(s, e).indicatorFullName)),
              h(
                "input",
          ...
          function b(i, s, e, o) {
            ...
            if (
              (b.forEach((t) => {
                let { indicatorFullName: i, indicatorType: s, series: e } = t;
                f = h(
                  "li",
                  { className: "highcharts-indicator-list" },
                  void 0,
              ...
              let { series: t, indicatorType: i } = b[0];
              n(t, i);
            } else
              u ||
                (t.setElementHTML(
          ...
          function v(t, i, s, e, n) {
            ...
            u(s, (s, r) => {
              ...
              if (c(s) && l) {
                if (
                  (d(s) &&
                    (a.call(this, l, e, n, {}), v.call(this, t, l, s, e, n)),
                  l in o)
                ) {
                  let o = A.call(this, e, l, n);
                  C.call(this, t, i, o, e, r, s);
                } else
                  "params.volumeSeriesID" === l ||
                    p(s) ||
                    a.call(this, l, e, n, { value: s, type: "number" });
              }
            });
          }
          function y(t, i) {
            let s = this,
              ...
              c = h("a", { textContent: o }, void 0, n);
            r.classList.add("highcharts-input-search-indicators"),
              c.classList.add("clear-filter-button"),
              l(r, "input", function () {
                a(this.value),
                  this.value.length
          ...
          function A(t, i, s) {
            let e = i.split("."),
              ...
              r = this.lang;
            h("label", { htmlFor: n }, null, s).appendChild(
              a.createTextNode(r[o] || i)
            );
            let l = h(
              "select",
              {
            ...
            "series" === i || "volume" === i
              ? t.series.forEach((t) => {
                  ...
                  "highcharts-navigator-series" !== e.id &&
                    e.id !== (r && r.options && r.options.id) &&
                    (c(n) ||
                      "volume" !== i ||
                      "column" !== t.type ||
                      (n = e.id),
                    h("option", { value: e.id }, void 0, s).appendChild(
                      a.createTextNode(o)
                    ));
                })
              : e &&
                o &&
                m[o + "-" + e].forEach((t) => {
                  h("option", { value: t }, void 0, s).appendChild(
                    a.createTextNode(t)
                  );
                }),
              c(n) && (s.value = n);
            ...
            return (
              u(t, (t, e) => {
                ...
                if (t.params || (a && a.params)) {
                  let { indicatorFullName: a, indicatorType: r } = k(t, e);
                  if (i) {
                    let e = RegExp(
                        i.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"),
                        "i"
          ...
          function w(t, i, s, e, o, n) {
            ...
            C.call(this, s, i, a, void 0, void 0, void 0, o),
              c(n) && (a.value = n);
          }
          return {
      ...
      s(
        ...
        function (t, i) {
          ...
          function a(t, i) {
            ...
            let r = o("button", { className: a }, void 0, e);
            return (
          ...
          return {
            compose: function (t, i) {
              n(e, "Popup") &&
                (o(t, "closePopup", r),
                o(t, "showPopup", l),
                a(i.prototype, "onContainerMouseDown", h));
            },
          };
        }
      ),
      s(
        ...
        function (t, i, s, e, o, n, a, r, l, h, c, p, d, u, g) {
          let { getDeferredAnimation: m } = t,
            {
          ...
          class E extends p {
            ...
            constructor(t, i) {
              super(),
                ...
                (this.labels = []),
                (this.shapes = []),
                (this.options = v(this.defaultOptions, i)),
                (this.userOptions = i);
            ...
            destroy() {
              ...
              this.labels.forEach(i),
                ...
                (this.clipXAxis = null),
                (this.clipYAxis = null),
                x(t.labelCollectors, this.labelCollector),
                super.destroy(),
                this.destroyControlTarget(),
                f(this, t);
            }
              ...
              t.linkPoints(),
                t.shouldBeDrawn()
                  ? (t.graphic || this.renderItem(t),
                    t.redraw(y(i, !0) && t.graphic.placed),
                    t.points.length &&
                      (function (t) {
                        let i = t.graphic,
                          s = t.points.some(
      ...
      s(
        ...
        function (t, i, s, e, o, n, a) {
          let { setOptions: r } = i,
            ...
            { getAssignedAxis: d, getFieldType: u } = n,
            {
              addEvent: g,
              attr: m,
              defined: f,
          ...
          function B() {
            ...
            t &&
              ...
              ((this.navigationBindings = new D(this, t.navigation)),
          ...
          class D {
            ...
            initEvents() {
              ...
              (t.boundClassNames = {}),
                ...
                E(o.events || {}, (i, s) => {
                  v(i) && t.eventsToUnbind.push(g(t, s, i, { passive: !1 }));
                }),
                t.eventsToUnbind.push(
                  g(i.container, "click", function (s) {
                    !i.cancelClick &&
                      i.isInsidePlot(
                        s.chartX - i.plotLeft,
                        s.chartY - i.plotTop,
            ...
            bindingsButtonClick(t, i, s) {
              ...
              this.selectedButtonElement &&
                (this.selectedButtonElement.classList === t.classList &&
                  (n = !1),
            ...
            update(t) {
              (this.options = C(!0, this.options, t)),
                this.removeEvents(),
                this.initEvents();
            }
            removeEvents() {
      ...
      s(
        ...
        function (t, i, s) {
          return (
            (t.Annotation = t.Annotation || i),
            (t.NavigationBindings = t.NavigationBindings || s),
            t.Annotation.compose(
              t.Chart,
