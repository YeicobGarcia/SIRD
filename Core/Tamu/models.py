...
class TamuModel(models.Model):
    ...
    seccionId = models.ForeignKey(LineaSeccion, on_delete=models.CASCADE)
    peso_objetivo = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    peso_obtenido = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    humedad_objetiva = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    humedad_obtenida = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    temperatura_objetiva = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    temperatura_obtenida = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
